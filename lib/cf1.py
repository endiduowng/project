...
class CF(object):
    ...
    def print_recommendation(self, cursor):
        ...
        for u in xrange(self.n_users):
            ...
            sql1 = "SELECT * FROM i_recommends WHERE item_id = %s"
            sql2 = "INSERT INTO i_recommends (item_id, recommend_list) VALUES (%s, %s)"
            sql3 = "UPDATE i_recommends SET recommend_list = %s WHERE item_id = %s"
